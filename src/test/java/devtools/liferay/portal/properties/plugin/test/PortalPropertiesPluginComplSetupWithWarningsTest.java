...
import static devtools.liferay.portal.properties.plugin.test.PortalPropertiesPluginTestKeys.PORTAL_PROPERTIES_COMPL_SETUP_WITH_WARNING.*;
 ...
 * }
 */
public class PortalPropertiesPluginComplSetupWithWarningsTest {
    ...
    public void testWarningMessages() {
        assertEquals(true, result.getOutput().contains("WARNING"));
    }
